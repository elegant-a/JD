<template>
 <div>
     ...
     <div class="order__btn" @click="()=>handleShowConifrmChange(true)">提交订单</div>
   </div>
   <div class="mask" v-show="showConfirm" @click="()=>handleShowConifrmChange(false)">
...
// 蒙层展示相关逻辑
const useShowMakkEffect = () =>{
   const showConfirm = ref(false)
    const handleShowConifrmChange = (status) =>{
         showConfirm.value = status
      }
      return{handleShowConifrmChange,showConfirm}
}
export default {
    name:'Order',
    ...
    setup(){
      ...
      const { handleShowConifrmChange,showConfirm } = useShowMakkEffect()

      return { calculations,handleConfirmOrder,handleShowConifrmChange,showConfirm }
    }
}
</script>
