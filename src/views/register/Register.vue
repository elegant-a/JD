<template>
    <div class="wrapper">
        ...
        <div class="wrapper__input">
            <input v-model="ensurement" class="wrapper__input__content" placeholder="确认密码" type="password" autocomplete="new-password">
        </div>
...
export default {
    ...
    setup(){
        ...
        return { username,password,handleRegister,ensurement,handleLoginClick,show,toastMessage }
    }
    }
...
@import '../../style/viriavles.scss';
 .wrapper{
     ...
     &__register-button{
         ...
         box-shadow: 0 .06rem .06rem 0 rgba(0,145,255,0.32);
         border-radius: .06rem;
         border-radius: .06rem;
         color: $bgColor;
         font-size: .16rem;
